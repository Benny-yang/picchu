...
import { PlusCircle, Heart, Menu } from 'lucide-react';
import NotificationDropdown from './NotificationDropdown';
import ApplicationReviewModal from './ApplicationReviewModal';
import MobileMenu from './MobileMenu';
import ProfileDropdown from './ProfileDropdown';

const LOGO_URL = "http://localhost:3845/assets/1ba42fafc6078cf31470ca2d8623c607689d4c56.svg";
const DEFAULT_AVATAR = "http://localhost:3845/assets/267ad1258bb3d96ddeb6f672046977adb61e7b64.png";

interface MainHeaderProps {
    activePage?: 'works-wall' | 'activities' | 'create-activity' | 'profile';
}

const MainHeader: React.FC<MainHeaderProps> = ({ activePage }) => {
        ...
        <div className="w-full h-[60px] bg-[#f7f7f7] shadow-[0px_1px_4px_0px_rgba(25,25,25,0.15)] relative z-50">
            <div className="w-full h-full px-4 md:px-8 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-6">
                    ...
                    <button
                        className="hover:opacity-70 transition-opacity"
                        onClick={() => window.location.href = '?view=create-activity'}
                    >
                        {activePage === 'create-activity' ? (
                            ...
                            <PlusCircle className="w-6 h-6 text-[#666666]" />
                        )}
                    </button>
                    ...
                    <div className="relative" ref={notificationRef}>
                        ...
                        >
                            ...
                            {/* Notification Dot (Mock) - keep it for now */}
                    ...
                    <div className="relative">
                        <button
                            className={`w-8 h-8 rounded-full overflow-hidden border cursor-pointer hover:opacity-80 transition-all ${activePage === 'profile' ? 'border-[#009bcd] ring-2 ring-[#009bcd]/20' : 'border-gray-200'}`}
