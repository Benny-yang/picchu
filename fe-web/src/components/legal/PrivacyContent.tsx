        ...
        <div className="text-[#666] text-[16px] font-normal leading-[1.8] space-y-6 whitespace-pre-wrap">
            ...
            <div>
                ...
                <ul className="list-disc pl-5 space-y-2">
                    ...
                    <li>{`為了註冊成為 拍揪 的用戶，您將被要求使用 Facebook 帳號或是手機碼登入。如果您選擇使用 Facebook 帳號登入，您同意我們為您取得您的身份驗證資訊以及其他您在 Facebook 帳號上公開之資訊（包含姓名、個人照片、年齡與性別等）及其他您同意 Facebook 提供給我們之資訊。您使用本服務，即代表您同意本隱私權政策。`}</li>
